	...
	<body style="text-align: center;">
		...
		<?php 
			...
			for ($i=0; $i < sizeof($nodesNewStation) ; $i++) {  
				...
				if(($nodesNewStation[$i] == ($stationD2.'t')) AND ($_SESSION['d2']->taxi > 0)){
					$taxi = true;
				}

				if(($nodesNewStation[$i] == ($stationD2.'b')) AND ($_SESSION['d2']->bus > 0)){
					$bus = true;
				}

				if(($nodesNewStation[$i] == ($stationD2.'s')) AND ($_SESSION['d2']->train > 0)){
					$train = true;
				}
			}	
